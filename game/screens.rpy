...
screen main_menu():
    ...
    # Фон главного меню — деревня утром
    add im.Scale("images/деревня_утро.png", config.screen_width, config.screen_height)

    # Полупрозрачный тёмный слой для контраста кнопок (заметнее)
    add Solid("#00000099")

    # Добавляем героиню справа, чтобы встречала игрока
    add "images/спокойная_героиня.png" xalign 0.85 yalign 1.0
