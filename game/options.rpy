...
define config.name = _("Сердце Урала")
...
define gui.about = _p("""
История Айгуль и белого коня из сна, ведущих к Сердцу Урала.
Ветвящийся сюжет с множеством простых, значимых выборов и несколькими концовками.
""")
...
define build.name = "serdtse_urala"
...
init python:
    # Подключаем фоновую музыку для главного меню, если файл доступен
    if renpy.loadable("audio/bashkirskaya-narodnaya-kuray-bayas.mp3"):
        config.main_menu_music = "audio/bashkirskaya-narodnaya-kuray-bayas.mp3"
    elif renpy.loadable("audio/bashkir_theme.ogg"):
        config.main_menu_music = "audio/bashkir_theme.ogg"
    elif renpy.loadable("audio/main-menu-theme.ogg"):
        config.main_menu_music = "audio/main-menu-theme.ogg"
    else:
...
define config.save_directory = "serdtse_urala-1759320263"
